...
events = [{'name': 'Vault', 'ref': date(2012, 9, 3), 'pattern': type_1,
          ...
          {'name': 'Fleet Marks', 'ref': date(2012, 9, 5), 'pattern': type_1,
           'arguments': dict(duration=2, repeat=8)},
          {'name': 'Mirror', 'ref': date(2012, 9, 6), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=8)},
          {'name': 'Academy', 'ref': date(2012, 9, 7), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=8)},
          {'name': 'Crafting', 'ref': date(2012, 9, 8), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=16)},
          {'name': 'Path to 2409', 'ref': date(2012, 9, 8), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=16)},
          {'name': 'Officer Reports', 'ref': date(2012, 9, 9), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=16)},
          {'name': 'Mining', 'ref': date(2012, 9, 9), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=16)},
          {'name': 'Tour the Universe', 'ref': date(2012, 9, 10), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=16)},
          {'name': 'Multiphasic', 'ref': date(2012, 9, 10), 'pattern': type_1,
           'arguments': dict(duration=1, repeat=16)},
         ]
